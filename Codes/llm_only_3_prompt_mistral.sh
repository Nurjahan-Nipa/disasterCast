...
#SBATCH --gres=gpu:1
#SBATCH --job-name=mistral_ablation
...
echo "=========================================="
echo "MISTRAL ABLATION STUDY - 3 PROMPT TEMPLATES"
...
mkdir -p results/mistral_ablation/template_A
mkdir -p results/mistral_ablation/template_B
mkdir -p results/mistral_ablation/template_C
...
for TEMPLATE in "${TEMPLATES[@]}"; do
    ...
    for CITY in "${CITIES[@]}"; do
        for HORIZON in "${HORIZONS[@]}"; do
            ...
            OUTPUT="results/mistral_ablation/template_${TEMPLATE}/${CITY}_${HORIZON}_template${TEMPLATE}.json"
